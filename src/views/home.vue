<template>
  <div class="home-page">
    <main-layout :opened="opened">
      <div slot="header">
        <div class="user-info">
          <div class="change-role-btn" @click="handleChangePlatform">
            <div class="btn">
              返回导航页
          ...
          <head-msg></head-msg>
          <div class="el-dropdown-link" style="display: inline-flex;align-items: center">
            <img
              :src="defaultUserLogo"
          ...
          <el-dropdown @command="handleCommand" placement="bottom-end" trigger="click" @visible-change="handleShow">
            <i
      ...
      <div slot="aside">
        <div :class="'btn '+(opened?'':'btn-close')" @click="toggleSidebar">
          <i class="el-icon-sort"></i>
        </div>
        <el-menu router :collapse="!opened" unique-opened style="margin-top: 60px">
